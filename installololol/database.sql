...
CREATE TABLE IF NOT EXISTS `automation_settings` (
  `id` int NOT NULL AUTO_INCREMENT,
  `title` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `matching_type` enum('match_any','match_all') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `event_name` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `conditions` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `actions` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `related_to` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `clients` (
  ...
  `gst_number` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `stripe_customer_id` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `company` (
  ...
  `gst_number` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `is_default` tinyint(1) NOT NULL DEFAULT '0',
  `logo` mediumtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `deleted` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `event_tracker` (
  ...
  `status` enum('new','read') CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT 'new',
  `last_read_time` datetime DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `logs` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
...
CREATE TABLE IF NOT EXISTS `folders` (
  ...
  `folder_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `parent_id` int NOT NULL,
  `level` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
...
CREATE TABLE IF NOT EXISTS `help_categories` (
  ...
  `sort` int NOT NULL,
  `articles_order` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `status` enum('active','inactive') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'active',
  `deleted` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `invoices` (
  `id` int NOT NULL AUTO_INCREMENT,
  `type` enum('invoice','credit_note') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'invoice',
  `client_id` int NOT NULL,
  `project_id` int NOT NULL DEFAULT '0',
  ...
  `labels` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `last_email_sent_date` date DEFAULT NULL,
  `status` enum('draft','not_paid','cancelled','credited') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'draft',
  `tax_id` int NOT NULL DEFAULT '0',
  `tax_id2` int NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `labels` (
  ...
  `title` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `color` varchar(15) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `context` enum('event','invoice','note','project','task','ticket','to_do','subscription','client') CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `user_id` int NOT NULL DEFAULT '0',
  `deleted` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `context` (`context`)
...
CREATE TABLE IF NOT EXISTS `notes` (
  ...
  `color` varchar(14) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `notification_settings` (
  ...
  `notify_to_team` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `notify_to_team_members` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `notify_to_terms` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `sort` int NOT NULL,
  `deleted` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `event` (`event`)
...
CREATE TABLE IF NOT EXISTS `paypal_ipn` (
  `id` int NOT NULL AUTO_INCREMENT,
  `verification_code` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `payment_verification_code` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `invoice_id` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `reminder_settings` (
  ...
  `reminder_event` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `stripe_ipn` (
  ...
  `payment_method_id` int NOT NULL,
  `deleted` tinyint(1) NOT NULL DEFAULT '0',
  `setup_intent` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `subscription_id` int NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `subscriptions` (
  ...
  `note` mediumtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `labels` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `status` enum('draft','pending','active','cancelled') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'draft',
  `payment_status` enum('success','failed') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'success',
  `tax_id` int NOT NULL DEFAULT '0',
  `tax_id2` int NOT NULL DEFAULT '0',
  ...
  `company_id` int NOT NULL DEFAULT '0',
  `deleted` tinyint(1) NOT NULL DEFAULT '0',
  `type` enum('app','stripe') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'app',
...
CREATE TABLE IF NOT EXISTS `tasks` (
  ...
  `lead_id` int NOT NULL DEFAULT '0',
  `client_id` int NOT NULL DEFAULT '0',
  `context` enum('project','client','lead','invoice','estimate','order','contract','proposal','subscription','ticket','expense','general') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'general',
  `created_by` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `status_id` (`status_id`),
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `client_permissions` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `deleted` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `projects_vo` (
...
INSERT INTO `company` (`id`, `name`, `address`, `phone`, `email`, `website`, `vat_number`, `gst_number`, `is_default`, `logo`, `deleted`) VALUES
(1, 'Company Name', '', '', '', '', '', '', 1, '', 0);
...
(1, 'admin_first_name', 'admin_last_name', 'staff', 1, 0, 'admin_email', 'admin_password', NULL, 'active', NULL, 0, NULL, 0, 'Admin', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'male', NULL, NULL, '', 1, 1, '0000-00-00 00:00:00', NULL, 0, NULL, 0);
