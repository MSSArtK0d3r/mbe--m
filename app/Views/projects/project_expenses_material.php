<div class="card bg-white">
        ...
        <div class="card-body rounded-bottom" id="invoice-overview-container" style="position: relative; overflow-y: scroll;">
                <?php if (!empty($project_expenses_list_material)): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <p>No material expenses found for this project.</p>
                <?php endif; ?>
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col widget-expenses mt-4 mb-2">
                            ...
                            <?php
                            $totalAmount = 0;
                            foreach ($project_expenses_list_material as $expense) {
