<div class="card bg-white">
        ...
        <div class="card-body rounded-bottom" id="invoice-overview-container" style="position: relative; overflow-y: scroll;">
                ...
                <?php if (!empty($project_expenses_list_tools)): ?>
                    <?php foreach ($project_expenses_list_tools as $row): ?>
                        <div class="d-flex p-2 justify-content-between">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col widget-expenses mt-4 mb-2">
                            ...
                            <?php
                            $totalAmount = 0;
                            foreach ($project_expenses_list_tools as $expense) {
