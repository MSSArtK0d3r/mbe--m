    ...
    <div class="modal-body clearfix">
        <div class="container-fluid">
            ...
            <div class="form-group">
                <div class="row">
                    <label for="invoice_note" class=" col-md-3">Invoice Description</label>
                    <div class=" col-md-9">
                        <?php
            ...
            <?php if ($client_id && !$project_id || $get_client_id) { ?>
                <input type="hidden" name="invoice_client_id" value="<?php echo $client_id ?: $get_client_id; ?>" />
            <?php } else { ?>
                <div class="form-group">
                    <div class="row">
            ...
            <?php } ?>
            <?php if ($project_id || $get_project_id) { ?>
                <input type="hidden" name="invoice_project_id" value="<?php echo $project_id ?: $get_project_id; ?>" />
                <input type="hidden" name="cat" value="claim" />
            <?php } else { ?>
                <div class="form-group">
                    <div class="row">
